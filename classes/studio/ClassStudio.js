...
return status    
// let message = `${this.name} earned an average test score of ${this.averageScore()} and has a status of ${this.status()}`
// return message
   }
}
...
// console.log(maltese.averageScore())

// console.log(maltese.status())

//Add methods for adding scores, averaging scores and determining candidate status as described in the studio activity.

// console.log(averageScore(bbear.scores))
